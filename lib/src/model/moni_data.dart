...
class MoniData with _$MoniData {
  const factory MoniData({
    ...
    @Default([])
        List<AgentDetails> overdueAgents,
    ...
    @JsonKey(name: 'due_agents') @Default([]) List<AgentDetails> dueAgents,
    @JsonKey(name: 'active_agents')
    @Default([])
        List<AgentDetails> activeAgents,
    @JsonKey(name: 'inactive_agents')
    @Default([])
        List<AgentDetails> inactiveAgents,
  }) = _MoniData;
